...
<li id="fn-7">Native Rollups (EIP-8079): EXECUTE precompile, Status RES. Cf. Section 5.6-A: the binding is structural because the security proof is tied to the L1 state transition function, and migrating to another L1 requires migration to a different STF framework. <a href="#fnref-7">↩</a></li>
